...
Библиотека использует AES-256 шифрование для передачи сообщений и RSA-2048 совершения рукопожатия. Все пакеты сериализуются в бинарный формат BSON. Протокол подходит для обмена как мелкими, так и большими сообщениями.
